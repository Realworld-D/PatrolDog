...
import sys
import os
sys.path.append('/home/unitree/guide_dog_go1/unitree_legged_sdk-3.5.1/build') # Edit the path to "build" folder on your computer
...
class Unitree_Robot():
    ...
    def robot_top_control(self, mode, gaitType, speedLevel,
                                footRaiseHeight, bodyHeight, 
                                roll, pitch, yaw,
                                forwardSpeed, sidewaySpeed, rotateSpeed):
        self.cmd_init()
        mode = self.mode
        ...
        sidewaySpeed = self.sidewaySpeed
